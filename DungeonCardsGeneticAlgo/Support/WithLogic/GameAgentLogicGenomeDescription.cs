...
namespace DungeonCardsGeneticAlgo.Support.WithLogic
{
    public class GameAgentLogicGenomeDescription : IGenomeDescription<GameAgentLogicGenome>
    {
        ...
        public IEnumerable<IGenomeProperty<GameAgentLogicGenome>> Properties => new IGenomeProperty<GameAgentLogicGenome>[]
        {
            ...
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenNotPossessingWeaponScoreMultiplier[0],
                (g, val) => g.WeaponWhenNotPossessingWeaponScoreMultiplier[0] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenNotPossessingWeaponScoreMultiplier[1],
                (g, val) => g.WeaponWhenNotPossessingWeaponScoreMultiplier[1] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenNotPossessingWeaponScoreMultiplier[2],
                (g, val) => g.WeaponWhenNotPossessingWeaponScoreMultiplier[2] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new ExpressionGenomeProperty<GameAgentLogicGenome, GameState>(g => g.MonsterWhenPossessingWeaponScoreFunc,
                (g, val) => g.MonsterWhenPossessingWeaponScoreFunc = val, _generator),
            new ExpressionGenomeProperty<GameAgentLogicGenome, GameState>(g => g.MonsterWhenNotPossessingWeaponScoreFunc,
                (g, val) => g.MonsterWhenNotPossessingWeaponScoreFunc = val, _generator),
