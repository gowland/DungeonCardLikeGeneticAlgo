...
namespace DungeonCardsGeneticAlgo.Support
{
    public class GameAgentLogicGenomeDescription : IGenomeDescription<GameAgentLogicGenome>
    {
        ...
        public GameAgentLogicGenomeDescription(IRandom random)
        {
            _random = random;
        }

        public IEnumerable<IGenomeProperty<GameAgentLogicGenome>> Properties => new[]
        {
            ...
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.MonsterWhenNotPossessingWeaponScoreMultiplier[2],
                ...
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenPossessingWeaponScoreMultiplier[0],
                (g, val) => g.WeaponWhenPossessingWeaponScoreMultiplier[0] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenPossessingWeaponScoreMultiplier[1],
                (g, val) => g.WeaponWhenPossessingWeaponScoreMultiplier[1] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
            new DoubleGenomeProperty<GameAgentLogicGenome>(g => g.WeaponWhenPossessingWeaponScoreMultiplier[2],
                (g, val) => g.WeaponWhenPossessingWeaponScoreMultiplier[2] = val, _minMultiplierValue,
                _maxMultiplierValue, _minChange, _maxChange, _random),
